...
function CodingQsComp() {
  return <div className='scrollbar' id='style-4' style={{backgroundColor:'white',height:'480px'}}>
...
1≤X,Y≤104
Y≤Z≤104
<h5><b>Sample Input 1 </b></h5>
<textarea defaultValue={`3 
2 5 20
3 1 2
4 5 6`} style={{height:'fit-content'}} disabled></textarea>

<h5><b>Sample Output 1 </b></h5>
<textarea defaultValue={`30
3
4`} style={{height:'fit-content'}} disabled></textarea>

<h5><b>Explanation</b></h5>
<h6><b>Test Case 1:</b></h6>Chef bought X=2 stocks for Y=5 each, making the total amount spent by Chef =2⋅5=10.
...
<h6><b>Test Case 2:</b></h6> Chef bought X=3 stocks for Y=1 each, making the total amount spent by Chef =3⋅1=3.
...
<h6><b>Test Case 3:</b></h6> Chef bought X=4 stocks for Y=5 each, making the total amount spent by Chef =4⋅5=20.
