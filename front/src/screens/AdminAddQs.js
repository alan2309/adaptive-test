...
function AdminAddQs() {
    ...
    function addOpt(e){
      setCountOpt(countOpt+1)
        ...
        <div class="form-check"   >
            <input class="form-check-input" name="correctOpt" type="radio" value={`option${countOpt+1}`} id="flexCheckDefault" required/>
            <label  style={{width:'100%'}} for="flexCheckDefault">
  ...
  <option value="3">Hard</option>
            ...
            <Row style={{marginTop:'70px'}}>
                <Col>
                <input className='rectangle'  name='question'  type='text' placeholder='Add Qs' style={{width:'100%'}} ></input>
                </Col>
            </Row>
            ...
            <Row style={{marginTop:'25px'}}>
                ...
                <div class="form-check"   >
                    <input class="form-check-input" name="correctOpt" type="radio" value="option1" id="flexCheckDefault" required/>
                    <label  style={{width:'100%'}} for="flexCheckDefault">
            ...
            <Row style={{marginTop:'25px'}}>
                ...
                <div class="form-check"   >
                    <input class="form-check-input" name="correctOpt" type="radio" value="option2" id="flexCheckDefault" required/>
                    <label  style={{width:'100%'}} for="flexCheckDefault">
            ...
            <Row style={{marginTop:'35px',paddingLeft:'200px'}}>
                 <Col>
                <button style={{backgroundColor:'#10B65C',width:'150px'}} type="button" onClick={(e)=>addOpt(e)} className='btn btn-primary'>Add option</button>
                </Col>
                 <Col>
                <button style={{backgroundColor:'#10B65C',width:'150px'}} type='submit' className='btn btn-primary'>Save</button>
                </Col>
            </Row>
            </form>
        </div>
